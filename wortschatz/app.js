...
const helpSections = [
  ...
  ['Search modes', [['≈ Fuzzy', 'Default. Finds close spellings and transposed letters; exact and substring matches rank first.'], ['" Literal', 'Finds the entered characters as a substring. Regex punctuation has no special meaning.'], ['.* Regex', 'Uses a regular expression. English is case-insensitive; German is case-sensitive unless an inline flag overrides it.']]],
